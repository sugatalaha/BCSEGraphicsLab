...
public:
    ...
    QLabel *label_13;
    QPushButton *scale;
    QPushButton *sutherlandcohenclip;
    QPushButton *sutherlandhodgemanclip;
    QPushButton *scale_about_point;
    QPushButton *rotate_about_point;
    QPushButton *shear_about_point;
    QPushButton *translate_about_point;
    QPushButton *reflect_about_line;
    QPushButton *make_window;
    QMenuBar *menubar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        xaxis_reflect->setGeometry(QRect(1120, 110, 81, 24));
        yaxis_reflect = new QPushButton(centralwidget);
        yaxis_reflect->setObjectName("yaxis_reflect");
        yaxis_reflect->setGeometry(QRect(1090, 70, 81, 24));
        ...
        sutherlandcohenclip = new QPushButton(centralwidget);
        sutherlandcohenclip->setObjectName("sutherlandcohenclip");
        sutherlandcohenclip->setGeometry(QRect(1020, 270, 141, 24));
        sutherlandhodgemanclip = new QPushButton(centralwidget);
        sutherlandhodgemanclip->setObjectName("sutherlandhodgemanclip");
        sutherlandhodgemanclip->setGeometry(QRect(1010, 320, 161, 24));
        scale_about_point = new QPushButton(centralwidget);
        scale_about_point->setObjectName("scale_about_point");
        scale_about_point->setGeometry(QRect(1080, 360, 101, 24));
        rotate_about_point = new QPushButton(centralwidget);
        rotate_about_point->setObjectName("rotate_about_point");
        rotate_about_point->setGeometry(QRect(1050, 390, 131, 24));
        shear_about_point = new QPushButton(centralwidget);
        shear_about_point->setObjectName("shear_about_point");
        shear_about_point->setGeometry(QRect(1050, 430, 131, 24));
        translate_about_point = new QPushButton(centralwidget);
        translate_about_point->setObjectName("translate_about_point");
        translate_about_point->setGeometry(QRect(1090, 460, 121, 24));
        reflect_about_line = new QPushButton(centralwidget);
        reflect_about_line->setObjectName("reflect_about_line");
        reflect_about_line->setGeometry(QRect(1090, 490, 101, 24));
        make_window = new QPushButton(centralwidget);
        make_window->setObjectName("make_window");
        make_window->setGeometry(QRect(1140, 20, 91, 24));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        sutherlandcohenclip->setText(QCoreApplication::translate("MainWindow", "Sutherland-cohen-clip", nullptr));
        sutherlandhodgemanclip->setText(QCoreApplication::translate("MainWindow", "Sutherland-hodgeman-clip", nullptr));
        scale_about_point->setText(QCoreApplication::translate("MainWindow", "Scale about point", nullptr));
        rotate_about_point->setText(QCoreApplication::translate("MainWindow", "Rotate about point", nullptr));
        shear_about_point->setText(QCoreApplication::translate("MainWindow", "Shear about point", nullptr));
        translate_about_point->setText(QCoreApplication::translate("MainWindow", "Translate about point", nullptr));
        reflect_about_line->setText(QCoreApplication::translate("MainWindow", "Reflect about line", nullptr));
        make_window->setText(QCoreApplication::translate("MainWindow", "make window", nullptr));
    } // retranslateUi
